...
- [X] T120 [US2] Constrain a runner to the baseline's 6 cores and 8 GB. The code applies
...
- [X] T121 [US2] Measure warm start. `Metric` declares no `WarmStart` and nothing collects
