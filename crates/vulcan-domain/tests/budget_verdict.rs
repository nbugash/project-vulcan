...
fn the_constitution_defines_thirteen_budgets() {
    // Twelve after v4.2.0 removed the idle processor budget, thirteen once warm
    // start was added: a second launch does not repeat the work of the first,
    // and the difference is what the page cache is worth.
